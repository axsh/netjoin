...
echo "#### Adding Client"
bin/ducttape clients linux add client1 --server server1 --ip-address 192.168.56.100 --username vagrant --key-pem test/keys/insecure_private_key --file_key test/keys/client.ovpn
